...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of StateMachineFW.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/David Jangdal/StateMachineFW'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'David Jangdal' => 'david.jangdal@ffcg.se' }
  s.source           = { :git => 'https://github.com/David Jangdal/StateMachineFW.git', :tag => s.version.to_s }
